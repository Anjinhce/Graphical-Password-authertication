...
def sendLoginLinkMailToUser(username):
    ...
    if user.logininfo.login_link is None:
        ...
        email = EmailMessage(
            ...
            body='''
            Someone trying to Access your your account. Your accout is  blocked currently please  reset your password to log in again
...
def register_page(request):
    if request.method == 'POST':
        ...
        if(len(password)<21):
            messages.warning(request,'Please select minimum 8 objects for password')
